...
export function combineEpics<
  ...
  IE1 extends keyof Es = keyof Es,
  OE1 extends IE1 = IE1,
  IE2 extends keyof Es = keyof Es,
  OE2 extends IE2 = IE2
> (
  e1: Epic<S, Es, IE1, OE1>,
  e2: Epic<S, Es, IE2, OE2>
): Epic<S, Es, IE1 | IE2, OE1 | OE2>
export function combineEpics<
  S,
  Es = any,
  IE1 extends keyof Es = keyof Es,
  ...
  IE2 extends keyof Es = keyof Es,
  OE2 extends IE2 = IE2,
  IE3 extends keyof Es = keyof Es,
  OE3 extends IE3 = IE3
> (
  e1: Epic<S, Es, IE1, OE1>,
  e2: Epic<S, Es, IE2, OE2>,
  e3: Epic<S, Es, IE3, OE3>
): Epic<S, Es, IE1 | IE2 | IE3, OE1 | OE2 | OE3>
export function combineEpics<
  S,
  Es = any,
  IE1 extends keyof Es = keyof Es,
